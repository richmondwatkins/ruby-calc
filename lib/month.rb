...
class Month
  ...
  def leap_year
    year = [nil,31,28,31,30,31,30,31,31,30,31,30,31]
    non_leap =
    if @year%4 == 0 && @year%100 != 0
      year = [nil,31,29,31,30,31,30,31,31,30,31,30,31]
      if @year % 100 == 0
        year = [nil,31,28,31,30,31,30,31,31,30,31,30,31] unless (@year % 400 == 0)
      end
    end
    year
  end
